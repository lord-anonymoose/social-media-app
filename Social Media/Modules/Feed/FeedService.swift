...
class Service {
    private let posts: [StorageService.Post] = [
        ...
        StorageService.Post(author: "tim_cook", description: "What an incredible week in India! Thanks to our teams across the country. I can't wait to return! 🙏🇮🇳", image: "tim_cook_post1", likes: 52_316, views: 2_900_231),
        ...
        StorageService.Post(author: "ijustine", description: "Trying Final Cut for iPad! New vid on my channel 👀", image: "ijustine_post3", likes: 5_351, views: 20_102),
    ...
    func fetchPosts(completion: @escaping (Result<[StorageService.Post], Error>) -> Void) {
        DispatchQueue.global().asyncAfter(deadline: .now() + 5, execute: { [weak self] in
